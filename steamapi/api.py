from steamapi.helpers import _apicall, str_format
...
class ISteamUserStats:
    ...
    def get_global_stats_for_game(self, appid, count, stats, startdate, enddate):
        global_stats = _apicall(f'https://api.steampowered.com/ISteamUserStats/GetGlobalStatsForGame/v1/?key={self.api_key}&appid={appid}&count={count}&name[0]={stats}&startdate={startdate}&enddate={enddate}')
